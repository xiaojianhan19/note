...
10000284	Language	英语音乐	Event	OnProcess
...
10001306	Exercise	楼梯训练	Event	OnProcess
10001307	TSSummit	障害3006_NSML_SEC_DEF_TSS差分	Event	Finished
10001303	TSSummit	V6.2.14.5_Migration	Event	OnProcess
...
10001300	Language	晨练英语	Event	OnProcess
...
10001313	TSSummit	結合環境_V6.2.14.5	Event	OnProcess
\.
...
SELECT pg_catalog.setval('public.collection_id_seq', 30000582, true);
...
SELECT pg_catalog.setval('public.collection_item_id_seq', 31000256, true);
...
SELECT pg_catalog.setval('public.event_id_seq', 10001313, true);
...
SELECT pg_catalog.setval('public.event_item_id_seq', 11010321, true);
